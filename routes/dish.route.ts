...
dishRoute.get("/categories/:dish_category_id", DishController.getDishCategoryById);
dishRoute.get('/i/:dish_id', DishController.getDishById);
dishRoute.get('/dishes', DishController.getDishes);
dishRoute.get('/dishes/:dish_category_id', DishController.getDishesByCategoryId);

dishRoute.use(roleMiddleware(true));

dishRoute.post("/categories", DishController.createDishCategory);
dishRoute.patch("/categories/:dish_category_id", DishController.updateDishCategory);
dishRoute.delete("/categories/:dish_category_id", DishController.deleteDishCategory);
