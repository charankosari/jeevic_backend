...
export class AddressController {
  ...
  public static readonly deleteAddress = async (ctx: Context) => {
    try {
      ...
      await AddressService.deleteAddress(user_id, address_id);
  ...
  public static readonly getAddresses = async (ctx: Context) => {
    try {
      ...
      const response = await AddressService.getAddresses(user_id);
  ...
  public static readonly setDefaultAddress = async (ctx: Context) => {
    try {
      ...
      await AddressService.setDefaultAddress(user_id, address_id);
  ...
  public static readonly getAddress = async (ctx: Context) => {
    try {
      ...
      const response = await AddressService.getAddress(user_id, address_id);
