...
export class SubcategoryController {
    ...
    public static readonly getSubCategory = async (ctx: Context) => {
        try {
            ...
            const response = await SubCategoryService.getSubCategoryById(subcategory_id);
    ...
    public static readonly createCategory = async (ctx: Context) => {
        try {
            const { name, category_id } = await ctx.req.json();
    ...
    public static readonly getSubCategoriesByCategory = async (ctx: Context) => {
        try {
            ...
            const response = await SubCategoryService.getSubCategoriesByCategory(category_id);
